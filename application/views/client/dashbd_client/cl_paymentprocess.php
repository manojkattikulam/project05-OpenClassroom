...
<?php
   ...
   if($status == 200 AND strpos($response, 'SUCCESS') === 0 ){
        ...
        redirect('Client_Achat/paymentsuccess');
        ...
        echo '<div class="alert alert-danger text-center">
              ...
              <strong>Desolé!</strong> Le paiement n\'a pas abouti <br><a href=" ' . base_url('Client_Panier') . ' " > Veuillez reessayer s\'il vous plaît </a>
            </div>';
    }
